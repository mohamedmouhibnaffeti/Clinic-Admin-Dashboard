...
function UpdateDoctor(props){
    ...
    const HandleUpdate = async()=>{
        const response = await APIService.UpdateDoctor(TOKEN, props.id,Doctor)
    ...
    return props.Trigger ? (
        <div className="update-popup">
            <div className="update-popup-inner">
                ...
                <h1 id="update-txt">Update Doctor</h1>
                    ...
                    <div update-input-container>
                        <FormControl style={{marginTop : 18, display : "flex", flexDirection : 'column'}}>
                            ...
                            <Button variant="contained" style={{marginTop : '20px', width : '100px', alignSelf : 'center'}} onClick={HandleUpdate} >Confirm</Button>
                        </FormControl>
                    </div>
                </div>
            </div>
